...
(function($){
    ...
    $.widget("ui.coverflow", {
        ...
        _create: function() {
            ...
            $(document.getElementsByTagName('iframe')).each(function(index, item){
                document.getElementById(item.id).contentDocument.addEventListener('click', function() {
                self.select(item.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement);
            });
            });
