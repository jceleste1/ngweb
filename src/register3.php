...
<TABLE cellSpacing=3 cellPadding=1  border=0 width='100%' align='center'>
 ...
 <tr>
	<td bgcolor=#EFEFEF colspan=2 align=center valign=middle height='45 px'><font class=subtitulo3>Para que possa utlizar o site<font color=darkgreen> <b>NegociosLucrativos.com.br</b></font> é necessário que preencha o formulário abaixo</td>
 </tr>	

 <tr>
	<td bgcolor=#EFEFEF colspan=2 align=center valign=middle height='45 px'><font class=msgAlert>Campos com * são obrigatórios</td>
 </tr>	
...
NegociosLucrativos não são permitidos anúncios para sites contendo ou linkados a: pornografia, palavras de calão, exploração
de crianças, racismo, profanação, incitação ao ódio, instruções sobre atividades ilegais, qualquer coisa ilegal ou
qualquer material que possa estar  insultando outra pessoa, empresa ou comunidade.
Não é permitida a cópia ou utilização, mesmo que atribuindo-se os créditos aos autores, de material protegido por leis de
direitos autorais sem a autorização expressa dos mesmos.
NegociosLucrativos.com se reserva o direito de remover de seu banco de dados qualquer publicação, que violar qualquer uma 
dessas regras, sem prévio aviso.
NegociosLucrativos.com não dá garantias de disponibilidade do serviço.
NegociosLucrativos.com também não se responsabiliza por nenhuma perda de dados resultante de nossa deleção de publicações e 
notícias, problemas na rede ou sistema, arquivos corrompidos, ou qualquer outra razão.NegociosLucrativos.com reserva o direito 
de alterar este termo de concordância a qualquer momento sem prévio aviso.
</textarea>	
	</td>
 </tr>
